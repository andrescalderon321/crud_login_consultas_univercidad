...
<body>
  ...
  <br><label for="lidAlumno">Materias que ve el estudiante con codigo "AL005" :</label><br>
  <table class="table table-striped  table-sm table-hover">
    ...
    <tbody>
      <?php
      $query = "SELECT asignatura.idAsignatura, asignatura.curso, asignatura.nombreAs, asignatura.creditos FROM alumno JOIN matricula ON alumno.idAlumno= matricula.idAlumno JOIN asignatura ON matricula.idAsignatura = asignatura.idAsignatura WHERE alumno.idAlumno = 'AL005'";
