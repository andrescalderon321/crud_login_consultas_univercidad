...
<body>
  ...
  <br><label for="lidAlumno">Estudiantes que ven la materia “Algebra lineal”:</label><br>
  <table class="table table-striped  table-sm table-hover">
    ...
    <tbody>
      <?php
      $query = "SELECT alumno.idAlumno, alumno.nombre, alumno.apellido1, alumno.email, alumno.beca FROM alumno JOIN matricula ON alumno.idAlumno = matricula.idAlumno JOIN asignatura ON matricula.idAsignatura= asignatura.idAsignatura WHERE asignatura.nombreAs = 'Algebra lineal'";
